...
namespace _001_Scripts.Structure
{
    ...
    public class BuoyancyController : MonoBehaviour
    {
        ...
        [Obsolete("Trigger water entry is no longer required; buoyancy uses IWaterQueryService.")]
        public void HandleEnterWater(IWaterbody water) { }

        [Obsolete("Trigger water exit is no longer required; buoyancy uses IWaterQueryService.")]
